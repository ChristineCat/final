...
*****************************************/
DROP DATABASE IF EXISTS my_guitar_shop1_ccatania;
CREATE DATABASE my_guitar_shop1_ccatania;
USE my_guitar_shop1_ccatania;  -- MySQL command
...
*****************************************/
DROP DATABASE IF EXISTS my_guitar_shop2_ccatania;
CREATE DATABASE my_guitar_shop2_ccatania;
USE my_guitar_shop2_ccatania;
